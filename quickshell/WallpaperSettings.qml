    ...
    PopupWindow {
        ...
        Rectangle {                                             // Fondo del popup
            ...
            ColumnLayout {                                      // Lista de fondos arriba y botón "Abrir carpeta" abajo
                ...
                Rectangle {                                     // Botón "Abrir carpeta": fuera del Flickable para que se vea siempre, haya los fondos que haya
                    id: openFolder
                    Layout.fillWidth: true
                    implicitHeight: 28
                    radius: 4
                    color: folderMouse.containsMouse ? Theme.surfaceHover : "transparent"   // Mismo estilo que las filas de Power.qml
                    ...
                    Item {
                        ...
                        Text {
                            text: String.fromCodePoint(0xF0770)  // folder-open
                            color: Theme.textActive
                            font.pixelSize: 15
